...
{
    public class InitialAssessmentQAViewModelCustom
    {
        public Patient Patient { get; set; }
        public Case Case { get; set; }
        //   public IEnumerable<ReferrerPricingValue> ReffererProjectTreatmentPricings { get; set; }
        ...
        public HttpPostedFileBase InitialAssessmentFileFinal { get; set; }
        ...
        public string InitialAssesessmentCustomFilePath { get; set; }
