...
namespace ITS.Domain.ViewModels
{
    public class PrintBlankFinalAssessmentViewModel
    {
        ...
        public IEnumerable<ITS.Domain.Models.CaseAssessmentModel.CaseTreatmentPricingType> CaseTreatmentPricingTypes { get; set; }
        public IEnumerable<ITS.Domain.Models.CaseAssessmentModel.CaseBespokeServicePricingType> CaseBespokeServicePricingTypes { get; set; }
