...
namespace ITSPublicApp.Infrastructure.ApplicationServices
{
    public class SupplierStorageService : ISupplierStorage
    {
        ...
        public bool CreateProjectTreatmentSupplierUploadFolder(int referrerID, int referrerProjectTreatmentID, string storagePath)
        {
            string path = Path.Combine(storagePath, SupplierRoot, referrerID.ToString(), referrerProjectTreatmentID.ToString());
            CreateDirectory(path);
            return true;
        }
        public string GetProjectTreatmentSupplierUploadFolderStoragePath(int supplierID, int referrerProjectTreamentID, int caseID, string fileName,
                                                      string storagePath)
        {
        ...
        public string GetProjectTreatmentSupplierUploadFolderStoragePath2(int supplierID, int referrerProjectTreamentID, int caseID, string fileName,
                                                      string storagePath)
        {
            return Path.Combine(storagePath, SupplierRoot, supplierID.ToString(), referrerProjectTreamentID.ToString(), caseID.ToString(), SupplierUploads, fileName);
